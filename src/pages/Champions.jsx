...
function Champions() {
  ...
  useEffect(() => {
    async function loadChampions() {
      try {
        ...
        const championStats = calculateChampionStats(participants, minGames);
        ...
        console.error(err);
        setError(`Erro ao carregar estatísticas dos campeões: ${err.message}`);
      }
    }
  ...
  return (
    <main>
      <h1>Estatísticas por Campeão</h1>
